...
public class Connect4ChipViewModel : BaseViewModel
{
    ...
    private Connect4ChipStates chipState = Connect4ChipStates.StartUnselected;
    ...
    public static double LoserHeight = 40;
    ...
    /// </summary>
    public Connect4ChipStates ChipState
    {
        get => chipState;
        set => SetProperty(ref chipState, value);
    }
