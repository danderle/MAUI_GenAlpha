namespace GenAlphaMaui.ViewModels
{
    ...
    public class Connect4ViewModel : BaseViewModel
    {
        ...
        private PlayerTurn winner = PlayerTurn.Player1;
        private SideMenuViewModel sideMenu = new();
        private Connect4TopBarViewModel topBar;
        private ObservableCollection<Connect4ChipViewModel> field = new();
        ...
        {
            get => moves;
            set => SetProperty(ref moves, value);
        }
        ...
        {
            get => sideMenu;
            set => SetProperty(ref sideMenu, value);
        }

        /// <summary>
        /// The top bar for this view model
        /// </summary>
        public Connect4TopBarViewModel TopBar
        {
            get => topBar;
            set => SetProperty(ref topBar, value);
        }

        /// <summary>
        /// The list of the connect4 field
        /// </summary>
        public ObservableCollection<Connect4ChipViewModel> Field
        {
            get => field;
        ...
        private void SetGameOverField()
        {
            foreach(Connect4ChipViewModel chip in Field)
            {
                ...
                {
                    chip.Height = Connect4ChipViewModel.LoserHeight;
                }
            }
        }
